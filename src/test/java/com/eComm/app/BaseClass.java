...
public class BaseClass {
	...
	public void startApp() throws MalformedURLException {
		...
		options.setApp("C://Users//samsu//eclipse-workspace//AppiumV2//src//test//java//resources//General-Store.apk");
	...
	public WebElement scrolltoFindEle(String eleTxt) {
		return driver.findElement(AppiumBy.androidUIAutomator(
				"new UiScrollable(new UiSelector()).scrollIntoView(text(\""+eleTxt+"\"));"));
	}
